---
title: "Exercise 9.1: Non-parametric test on the shrimps dataset - solution"   
...
```{r}
shrimps <- read.table("https://raw.githubusercontent.com/GTPB/PSLS20/master/data/shrimps.txt",
                      header = TRUE)
```
