...
In this exercise, we will learn how to import, tidy, wrangle and 
visualize data.
...
import the required datasets into our Rstudio environment.
...
have a look at the *extra1_preliminary_tidyverse.Rmd* file!
...
functions for handeling our data. We refer to the 
...
```{r, echo=FALSE}
knitr::include_graphics("../data/Figure_partners.png")
```
...
The information taht can be obtained from this histogram
...
dotplat or histogram is that we cannot see (from the figure)
...
Now the data seems to be approximately normal by eye (we will later show how to
