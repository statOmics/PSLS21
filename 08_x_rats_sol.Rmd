...
Boxplot of the weight gain against protein source and protein level
...
There is also an effect of the block. As the blocking implies a randomisation restriction we will have to include the block effect anyway. 
