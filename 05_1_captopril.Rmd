...
Performing a paired t-test is analogous to performing a one-sample 
t-test on the difference between both groups.

This can be spotted in the output of the paired 
t-test. The alternative hypothesis "HA" from the output states that 
